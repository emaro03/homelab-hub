...
See [`architecture.md`](/architecture.md) for the full diagram and write-up of how these pieces fit together (network flow, hypervisor layout, exposure via Cloudflare Tunnel/Tailscale instead of open ports).
